...
//  User List Data Table
    var Datatable=function() {
        ...
        var t=function() {
                var table = $('#businessinsigt_view_table').DataTable({
                "ajax":{
                    url :"<?php echo base_url()?>admin/businessinsigt/select", // json datasource
...
<script>
     ...
     $('body').on('click', '#businessinsigt_edit_btn', function() {
    ...
    $('body').on('click', '#businessinsigt_delete_btn', function() {
        var no = $(this).closest('tr').children('td');
