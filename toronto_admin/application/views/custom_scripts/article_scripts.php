...
//  User List Data Table
    var Datatable=function() {
        ...
        var t=function() {
                var table = $('#article_view_table').DataTable({
                "ajax":{
                    url :"<?php echo base_url()?>admin/article/select", // json datasource
        ...
        add=function() {
            $("#form_article_add").validate( {
                ...
                , invalidHandler:function(e, r) {
                    var i=$("#form_article_add_msg");
                    i.removeClass("m--hide").show(), mApp.scrollTo(i, -200)
                }
                , submitHandler:function(e) {
                    mApp.block("#article_add_modal .modal-content", {
                        overlayColor: "#000000",
                        type: "loader",
                        state: "success",
        ...
        edit=function() {
            $("#form_article_edit").validate( {
                    ...
                    , submitHandler:function(e) {
                        ...
                        mApp.block("#article_edit_modal .modal-content", {
                            overlayColor: "#000000",
                            type: "loader",
                            state: "success",
                            message: "Processing... Please wait."
...
<script>
     ...
     $('body').on('click', '#article_edit_btn', function() {
       ...
       // $('#image').val(no.eq(1).text());
        ...
        $('#write_by').val(no.eq(5).text());
        $('#link').val(no.eq(6).text());
