            ...
            <div class="m-content">
                ...
                <div class="m-portlet m-portlet--mobile m-portlet--mobile m-portlet--info m-portlet--head-solid-bg m-portlet--bordered m-portlet--rounded">
                    ...
                    <div class="m-portlet__body">
                        ...
                        <!--end: Search Form -->
                        <!--begin: Datatable -->
                        <table width="100%" class="table m-table nowrap table-header-fixed table-striped table-bordered table-hover table-header-fixed" id="article_view_table">
                            <thead>
                            <tr class="">
                                <th>ID</th>
                        ...
                        <div class="modal fade" tabindex="-1" id="article_add_modal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog " role="document" style="max-width: 675px">
                                <div class="modal-content">
                                    ...
                                    <form id="form_article_add" method="post" action="<?php echo base_url().$user_directory.'article/create'?>" class="m-form m-form--fit m-form--state m-form--label-align-right " enctype="multipart/form-data" >
                                                ...
                                                <div class="col-lg-12" >
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group m-form__group">
                                                         ...
                                                         <input type="text" name="link" class="col-lg-12" > 
                        ...
                        <div class="modal fade" tabindex="-1" id="article_edit_modal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog " role="document" style="max-width: 675px">
                                <div class="modal-content">
                                    ...
                                    <form id="form_article_edit" method="post" action="<?php echo base_url().$user_directory.'article/update'?>" class="m-form m-form--fit m-form--state m-form--label-align-right " enctype="multipart/form-data" >
                                        <div class="modal-body">
                                            <div class="m-form__content">
                                                ...
                                                <div class="col-lg-12" >
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group m-form__group">
                                                          ...
                                                          <input type="text" name="link" id="link" class="col-lg-12" >
                        ...
                        <div class="modal fade" tabindex="-1" id="article_delete_modal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog " role="document" >
                                <form id="user_delete_form" action="<?php echo base_url().$user_directory.'article/delete'?>" method="post" class="form-horizontal">
                                    <div class="modal-content">
...
<script>
    // Menu Active
    $("#menu_article").addClass('m-menu__item--active');
...
<!--begin::Page Snippets -->
<?php $this->view("custom_scripts/article_scripts");?>
<!--end::Page Snippets -->