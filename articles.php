                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-4 col-md-6 alt-font breadcrumb justify-content-center justify-content-md-end text-small sm-margin-10px-top">
                        ...
                        <ul>
                            ...
                            <li><a href="#" class="text-dark-gray">Articles</a></li>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-7 text-center sm-margin-40px-bottom">
                        <div class="position-relative overflow-hidden w-100">
                            <span style="margin-bottom: 30px;" class="text-small text-outside-line-full alt-font font-weight-600 text-uppercase">ARTICLES </span>
                        </div>
                    </div>
                </div>
                <div class="row">
                     ...
                     <?php
                               $res=$obj->select_articles(" where delete_status='0'");
                        ...
                        <div class="blog-post bg-light-gray inner-match-height">
                            <div class="blog-post-images overflow-hidden position-relative">
                                <a href="<?php echo $row['link']; ?>">
                                     <img class="img-fluid" src="toronto_admin/uploads/article/<?php echo $row['article_image']; ?>"style="width: 100%; height: 300px">
                                    <div class="blog-hover-icon"><span class="text-extra-large font-weight-300">+</span></div>
                                </a>
                            </div>
                            <div class="post-details padding-40px-all md-padding-20px-all">
                                <a href="https://www.entrepreneur.com/article/228878" class="alt-font post-title text-medium text-extra-dark-gray width-100 d-block lg-width-100 margin-15px-bottom"><?php echo $row['title']; ?></a>
                                <p><?php echo $row['description']; ?></p>
                                <div class="separator-line-horrizontal-full bg-medium-gray margin-20px-tb"></div>
                                <div class="author">
                                    <span class="text-medium-gray text-uppercase text-extra-small d-inline-block"> <a href="https://www.entrepreneur.com/article/228878" class="text-medium-gray"><?php echo $row['write_by']; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<?php echo $row['created_date']; ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
